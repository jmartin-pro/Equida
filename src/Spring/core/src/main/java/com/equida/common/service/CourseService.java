...
public class CourseService {
	...
	public Course getById(Long idCourse) throws NotFoundException {
		if(idCourse == null) {
		...
		if(!course.isPresent()) {
			throw new NotFoundException("L'id de la course spécifié n'existe pas.");
		}
	...
	public Course updateCourse(Long idCourse, String nom, Date dateCourse, String ville) throws NotFoundException {
		if(idCourse == null) {
	...
	public void deleteCourse(Long idCourse) throws NotFoundException {
		if(idCourse == null) {
			throw new ServiceException("idCourse ne doit pas être null.");
		}
