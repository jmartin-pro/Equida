...
public class ClientService {
	...
	public Client getById(Long idClient) throws NotFoundException {
	...
	public Client update(Long idClient, String nom, String prenom, String rue, String copos, String ville, String mail) throws NotFoundException {
		if(idClient == null) {
	...
	public void delete(Long idClient) throws NotFoundException {
		if(idClient == null) {
			throw new ServiceException("idClient ne doit pas être null");
		}
