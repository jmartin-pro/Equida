...
public class ClientDetailsRestController {
	...
	public ClientDto getClient(@PathVariable(value = ClientDetailsApiRoute.PARAM_ID_CLIENT) Long idClient) {
	...
	public void updateClient(@PathVariable(value = ClientDetailsApiRoute.PARAM_ID_CLIENT) Long idClient, @RequestBody ClientDto clientDto) {
	...
	public void deleteClient(@PathVariable(value = ClientDetailsApiRoute.PARAM_ID_CLIENT) Long idClient) {
