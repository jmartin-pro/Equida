...
<div class="row">
    <div class="col s12">
        ...
        <p><strong>2. Description des services fournis :</strong><br />
            <br />
            Le site <a href="http://www.equida-jr.com" target="_blank">www.equida-jr.com</a> a pour objet de fournir une information concernant l’ensemble des activités de la société.<br />
            ...
            Tous les informations proposées sur le site <a href="http://www.equida-jr.com" target="_blank">www.equida-jr.com</a> sont données à titre indicatif, sont non exhaustives, et sont susceptibles d’évoluer. Elles sont données sous réserve de modifications ayant été apportées depuis leur mise en ligne.<br />
        </p>
        ...
        <p><br />
            ...
            Toute reproduction, représentation, modification, publication, adaptation totale ou partielle des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable à l'email : <a href="mailto:equidag2@rostand.fr?subject=Contact ï¿½ partir des mentions lï¿½gales via le site www.equida-jr.com"><strong>equidag2@rostand.fr</strong></a> .<br />
        ...
        <p><strong>5. Protection des biens et des personnes - gestion des données personnelles :</strong><br />
            <br />
            Utilisateur : Internaute se connectant, utilisant le site susnommé : <a href="http://www.equida-jr.com" target="_blank">www.equida-jr.com</a><br />
        ...
        <p>Le site <a href="http://www.equida-jr.com" target="_blank">www.equida-jr.com</a> est en conformité avec le RGPD voir notre politique RGPD</p>
